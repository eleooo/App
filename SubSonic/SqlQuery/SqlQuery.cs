...
namespace SubSonic
{
    ...
    public class SqlQuery
    {
        ...
        private List<string> __constraintExpressions = new List<string>();
        ...
        /// <summary>
        /// PagingSortExpression
        /// </summary>
        public string DefaultPagingSort { get; set; }
        ...
        public SqlQuery ConstraintExpression(string expression)
        {
            this.__constraintExpressions.Add(expression);
            return this;
        }

        public SqlQuery ConstraintExpression(string expression,params object[] expParams)
        {
            if(expParams != null)
                this.__constraintExpressions.Add(string.Format(expression,expParams));
            return this;
        }
        ...
        /// <param name="columnName">Name of the column.</param>
        /// <returns></returns>
        public Constraint OrEx(string columnName)
        {
            //as a convenience, check that the last constraint
            //is a close paren
            //if (Constraints.Count > 0 && (ClosedParenCount < OpenParenCount))
        ...
        /// <param name="columnName">Name of the column.</param>
        /// <returns></returns>
        public Constraint OrEx(TableSchema.TableColumn columnName)
        {
            //as a convenience, check that the last constraint
            //is a close paren
            //if (Constraints.Count > 0 && (ClosedParenCount < OpenParenCount))
            ...
            //}
            //OpenParenCount++;
            return OrEx(columnName.ColumnName);
        }
        ...
        /// <param name="columnName">Name of the column.</param>
        /// <returns></returns>
        public Constraint OrExpression(TableSchema.TableColumn columnName)
        {
            return OrExpression(columnName.ColumnName);
        }
        ...
        /// <param name="columnName">Name of the column.</param>
        /// <returns></returns>
        public Constraint AndEx(string columnName)
        {
            //as a convenience, check that the last constraint
            //is a close paren
            //if (Constraints.Count > 0 && (ClosedParenCount < OpenParenCount))
        ...
        /// <param name="columnName">Name of the column.</param>
        /// <returns></returns>
        public Constraint AndEx(TableSchema.TableColumn columnName)
        {
            //as a convenience, check that the last constraint
            //is a close paren
            //if (Constraints.Count > 0 && (ClosedParenCount < OpenParenCount))
            ...
            //}
            //OpenParenCount++;
            return this.AndEx(columnName.ColumnName);
        }
        ...
        /// <param name="columnName">Name of the column.</param>
        /// <returns></returns>
        public Constraint AndExpression(TableSchema.TableColumn columnName)
        {
            return AndExpression(columnName.ColumnName);
        }
        ...
        {
            QueryCommand cmd = new QueryCommand(BuildSqlStatement(), ProviderName);
        ...
        private void CreateJoin(TableSchema.Table from, Join.JoinType type, params string[] joinExpressions)
        {
            if (FromTables.Count == 0)
            ...
            Join j = new Join(from, to, type,joinExpressions);
        ...
        private void CreateJoin(TableSchema.TableColumn fromColumn, TableSchema.TableColumn toColumn, Join.JoinType type, params string[] joinExpressions)
        {
            Join j = new Join(fromColumn, toColumn, type, joinExpressions);
            Joins.Add(j);
        }

        private void CreateJoin(string fromTable, string fromColumn, string toTable, string toColumn, Join.JoinType type,params string[] joinExpressions)
        {
            TableSchema.Table from = DataService.GetSchema(fromTable, ProviderName);
            TableSchema.Table to = DataService.GetSchema(toTable, ProviderName);
            ...
            //set the join
            Join j = new Join(fromCol, toCol, type,joinExpressions);
        ...
        /// <returns></returns>
        public SqlQuery InnerJoin(TableSchema.TableColumn fromColumn, TableSchema.TableColumn toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromColumn, toColumn, Join.JoinType.Inner, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery InnerJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.Inner, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery OuterJoin(TableSchema.TableColumn fromColumn, TableSchema.TableColumn toColumn, params string[] joinExpressions)
        {
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery OuterJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.Outer, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery CrossJoin(TableSchema.TableColumn fromColumn, TableSchema.TableColumn toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromColumn, toColumn, Join.JoinType.Cross, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery CrossJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.Cross, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery LeftInnerJoin(TableSchema.TableColumn fromColumn, TableSchema.TableColumn toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromColumn, toColumn, Join.JoinType.LeftInner, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery LeftInnerJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.LeftInner, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery RightInnerJoin(string fromTable, string fromColumn, string toTable, string toColumn,params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.RightInner, joinExpressions);
            return this;
        }
        ...
        /// <param name="from">From.</param>
        /// <returns></returns>
        public SqlQuery LeftOuterJoin(TableSchema.Table from, params string[] joinExpression)
        {
            CreateJoin(from, Join.JoinType.LeftOuter, joinExpression);
            return this;
        }
        ...
        /// <param name="tableName">Name of the table.</param>
        /// <returns></returns>
        public SqlQuery LeftOuterJoin(string tableName,params string[] joinExpression)
        {
            TableSchema.Table schema = DataService.GetSchema(tableName, ProviderName);
            CreateJoin(schema, Join.JoinType.LeftOuter, joinExpression);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery LeftOuterJoin(TableSchema.TableColumn fromColumn, TableSchema.TableColumn toColumn, params string[] joinExpression)
        {
            CreateJoin(fromColumn, toColumn, Join.JoinType.LeftOuter, joinExpression);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery LeftOuterJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.LeftOuter, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery RightOuterJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.RightOuter, joinExpressions);
            return this;
        }
        ...
        /// <param name="toColumn">To column.</param>
        /// <returns></returns>
        public SqlQuery NotEqualJoin(string fromTable, string fromColumn, string toTable, string toColumn, params string[] joinExpressions)
        {
            CreateJoin(fromTable, fromColumn, toTable, toColumn, Join.JoinType.NotEqual, joinExpressions);
            return this;
        }
        ...
        public virtual int GetRecordCount()
        {
            ...
            try
            {
                ...
                //else
                {
                    QueryCommand command = new QueryCommand(GetGenerator().GetCountSelect(), ProviderName);
        ...
        {
            return DataService.GetDataTable(BuildCommand( ));
        }
        ...
        public virtual List<T> ExecuteTypedList<T>() where T : new()
        {
            ...
            //return result;
            return DataService.ExecuteListTypedResult<T>(BuildCommand());
        }
            ...
            where ListType : IAbstractList, new()
        {
            ...
            //}
            //return list;
            return DataService.ExecuteAsCollection<ListType>(BuildCommand());
        }
        ...
        public virtual T ExecuteSingle<T>() where T : new()
        {
            ...
            //        rdr.Close();
            //}
            return DataService.ExecuteTypedResult<T>(BuildCommand());
        }
        ...
        /// <summary>
        /// Gets or sets the Constraint expressions.
        /// </summary>
        /// <value>The Constraint expressions.</value>
        public List<string> ConstraintExpressions
        {
            get { return this.__constraintExpressions; }
            internal set { __constraintExpressions = value; }
        }
