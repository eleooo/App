...
namespace SubSonic
{
    ...
    public class InlineQuery
    {
        ...
        public List<T> ExecuteTypedList<T>(string sql, params object[] values) where T : new()
        {
            ...
            return DataService.ExecuteListTypedResult<T>(cmd);
        }
            ...
            where ListType : IAbstractList, new()
        {
            ...
            return DataService.ExecuteAsCollection<ListType>(cmd);
        }
        ...
        {
            return DataService.GetDataSet(GetCommand(sql, new object[0]));
        }
        ...
        {
            return DataService.GetDataSet(GetCommand(sql, values));
        }
