...
namespace SubSonic
{
    ...
    public static class CodeService
    {
        ...
        /// <summary>
        /// Builds the schema template.
        /// </summary>
        /// <param name="tableName">Name of the table.</param>
        /// <param name="language">The language.</param>
        /// <param name="provider">The provider.</param>
        /// <returns></returns>
        public static TurboTemplate BuildSchemaTemplate(string tableName, ICodeLanguage language, DataProvider provider)
        {
            DataService.LoadProviders();
            ...
            if (ShouldGenerate(tableName, provider.Name))
            {
                ...
                return PrepareTemplate(String.Concat("Schema - ", provider.Name, ": ", tableName), TemplateType.Schemes, list, language, provider);
            }

            Utility.WriteTrace(String.Format("Schema {0} is excluded from generation", tableName));
            return null;
        }
