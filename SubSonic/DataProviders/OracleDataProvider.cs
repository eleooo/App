    ...
    public class OracleDataProvider : DataProvider
    {
        ...
        public override string[] GetViewNameList()
        {
            if (ViewNames == null || ViewNames.Length == 0)
            {
                ...
                ViewNames = sList.ToString().Split(DELIMITER.ToCharArray(), StringSplitOptions.RemoveEmptyEntries);
        ...
        public override string[] GetTableNameList()
        {
            if (TableNames == null || TableNames.Length == 0)
            {
                ...
                TableNames = sList.ToString().Split(DELIMITER.ToCharArray(), StringSplitOptions.RemoveEmptyEntries);
