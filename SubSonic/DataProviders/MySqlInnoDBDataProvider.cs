...
";
        ...
        private readonly DataSet dsTables;

        public MySqlInnoDBDataProvider()
        {
            dsColumns = new DataSet("dsColumns");
            dsTables = new DataSet("dsTables");
        ...
        internal MySqlInnoDBDataProvider(NameValueCollection config, params object[] ds)
        {
            if (ds != null)
            {
                for (int i = 0; i < ds.Length; i++)
                {
                    ...
                    if (dataSet != null)
                    {
                        if (Utility.Compare(dataSet.DataSetName, "dsColumns"))
                            dsColumns = dataSet;
                        else if (Utility.Compare(dataSet.DataSetName, "dsTables"))
                            dsTables = dataSet;
