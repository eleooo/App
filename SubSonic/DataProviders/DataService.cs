...
namespace SubSonic
{
    ...
    public static class DataService
    {
        ...
        {
            return provider.GetGenerator(sqlQuery);
        }
        ...
        /// <returns>T</returns>
        public static T ExecuteTypedResult<T>(QueryCommand cmd) where T : new()
        {
            return GetInstance(cmd.ProviderName).GetTypedResult<T>(cmd);
        }

        /// <summary>
        /// Returns ListType result Collection
        /// </summary>
        /// <param name="cmd"></param>
        /// <returns>T</returns>
        public static ListType ExecuteAsCollection<ListType>(QueryCommand cmd) where ListType : IAbstractList, new()
        {
            return GetInstance(cmd.ProviderName).GetAsCollection<ListType>(cmd);
        }
        /// <summary>
        /// Returns list typed result
        /// </summary>
        /// <param name="cmd"></param>
        /// <returns>List<T></returns>
        public static List<T> ExecuteListTypedResult<T>(QueryCommand cmd) where T : new()
        {
            return GetInstance(cmd.ProviderName).GetListTypedResult<T>(cmd);
        }
        ...
        /// <summary>
        /// Returns a DataTable based on the passed-in command
        /// </summary>
        /// <param name="cmd"></param>
        /// <returns></returns>
        public static DataTable GetDataTable(QueryCommand cmd)
        {
        ...
        {
            return GetSchema(tableName, Provider.Name);
        }
