...
namespace Eleooo.DAL
{
	...
	/// </summary>
	[Serializable]
	public partial class SysMemberItemSchema : TableSchema.Table
	{
        public static TableSchema.Table Schema
        {
            get
            {
                return new SysMemberItemSchema();
            }
        }
		#region .ctors and Default Settings
		
		public SysMemberItemSchema()
            :base("Sys_Member_Item")
		{
		}
		...
		protected override void Initital() 
        {
            ...
            colvarItemStatus.ExtendedProperties.Add(new TableSchema.ExtendedProperty("SSX_COLUMN_DISPLAY_NAME","1 已抢购 2已消费 3 已过期"));
