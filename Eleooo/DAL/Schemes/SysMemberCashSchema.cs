...
namespace Eleooo.DAL
{
	...
	/// </summary>
	[Serializable]
	public partial class SysMemberCashSchema : TableSchema.Table
	{
        public static TableSchema.Table Schema
        {
            get
            {
                return new SysMemberCashSchema();
            }
        }
		#region .ctors and Default Settings
		
		public SysMemberCashSchema()
            :base("Sys_Member_Cash")
		{
		}
		...
		protected override void Initital() 
        {
			...
			colvarCashID.AutoIncrement = true;
			colvarCashID.IsNullable = false;
			colvarCashID.IsPrimaryKey = true;
			...
			TableSchema.TableColumn colvarCashRateSale = new TableSchema.TableColumn(this);
			colvarCashRateSale.ColumnName = "CashRateSale";
			colvarCashRateSale.DataType = DbType.Decimal;
			colvarCashRateSale.MaxLength = 0;
			colvarCashRateSale.AutoIncrement = false;
			colvarCashRateSale.IsNullable = true;
			colvarCashRateSale.IsPrimaryKey = false;
			colvarCashRateSale.IsForeignKey = false;
			colvarCashRateSale.IsReadOnly = false;
                
			colvarCashRateSale.DefaultSetting = @"";
			colvarCashRateSale.ForeignKeyTableName = "";
            colvarCashRateSale.ApplyExtendedProperties();
			this.Columns.Add(colvarCashRateSale);
