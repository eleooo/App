...
{
	/// <summary>
	/// This is an ActiveRecord class which wraps the v_Latest_Sys_Member_Ads table.
	/// </summary>
	[Serializable]
	public partial class VLatestSysMemberAdSchema : TableSchema.Table
	{
        public static TableSchema.Table Schema
        {
            get
            {
                return new VLatestSysMemberAdSchema();
            }
        }
		#region .ctors and Default Settings
		
		public VLatestSysMemberAdSchema()
            :base("v_Latest_Sys_Member_Ads")
		{
		}
