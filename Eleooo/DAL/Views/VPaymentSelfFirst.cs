...
namespace Eleooo.DAL{
    /// <summary>
    /// Strongly-typed collection for the VPaymentSelfFirst class.
    /// </summary>
    [Serializable]
    public partial class VPaymentSelfFirstCollection : ReadOnlyList<VPaymentSelfFirst, VPaymentSelfFirstCollection>
    {        
        public VPaymentSelfFirstCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the v_PaymentSelf_First view.
    /// </summary>
    [Serializable]
    public partial class VPaymentSelfFirst : ReadOnlyRecord<VPaymentSelfFirst>, IReadOnlyRecord
    {
	    ...
	    public static TableSchema.Table Schema
        {
            get
            {
                if (BaseSchema == null)
                {
                    BaseSchema = DB.GetSchema("v_PaymentSelf_First");
                }
                return BaseSchema;
            }
        }
        ...
        public VPaymentSelfFirst(bool useDatabaseDefaults)
	    { 
            if(BaseSchema == null)
                BaseSchema = DB.GetSchema("v_PaymentSelf_First");
	    ...
	    public VPaymentSelfFirst(object keyID)
	    { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_PaymentSelf_First");
		    LoadByKey(keyID);
	    ...
	    public VPaymentSelfFirst(string columnName, object columnValue)
        { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_PaymentSelf_First");
