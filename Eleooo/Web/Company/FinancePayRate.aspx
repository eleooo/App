<%@ Page Title="佣金结算记录" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="FinancePayRate.aspx.cs" Inherits="Eleooo.Web.Company.FinancePayRate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    ...
    <table class="tbl_body" border="0" cellspacing="1" cellpadding="5" width="100%">
        <tbody>
            <tr>
                <td class="tbl_row">
                    <b>说明</b>：<br /> <span runat="server" id="lblPointDesc"></span>
                </td>
            </tr>
        </tbody>
    </table>
