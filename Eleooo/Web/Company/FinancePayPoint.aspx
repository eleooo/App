<%@ Page Title="积分结算记录" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="FinancePayPoint.aspx.cs" Inherits="Eleooo.Web.Company.FinancePayPoint" %>
    ...
    <table class="tbl_body" border="0" cellspacing="1" cellpadding="5" width="100%">
        <tbody>
            <tr>
                <td class="tbl_row">
                    <b>说明</b>：
                    <br /> <span runat="server" id="lblPointDesc"></span>
                </td>
            </tr>
        </tbody>
    </table>
