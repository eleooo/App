...
namespace Eleooo.Web.Company
{
    public partial class SupportList : ActionPage
    {
        ...
        const string ALL_SUPPORT_LIST = "/Company/SupportList.aspx";
        const string NOT_START_SUPPORT_LIST = "/Company/SupportList.aspx?Status=1";
        const string IN_PROGRESS_SUPPORT_LIST_A = "/Company/SupportList.aspx?Status=2";
        const string COMPLETED_SUPPORT_LIST = "/Company/SupportList.aspx?Status=3";
