...
namespace Eleooo.DAL{
    /// <summary>
    /// Strongly-typed collection for the VOrdersCashCompany class.
    /// </summary>
    [Serializable]
    public partial class VOrdersCashCompanyCollection : ReadOnlyList<VOrdersCashCompany, VOrdersCashCompanyCollection>
    {        
        public VOrdersCashCompanyCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the v_Orders_CashCompany view.
    /// </summary>
    [Serializable]
    public partial class VOrdersCashCompany : ReadOnlyRecord<VOrdersCashCompany>, IReadOnlyRecord
    {
	    ...
	    public static TableSchema.Table Schema
        {
            get
            {
                if (BaseSchema == null)
                {
                    BaseSchema = DB.GetSchema("v_Orders_CashCompany");
                }
                return BaseSchema;
            }
        }
        ...
        public VOrdersCashCompany(bool useDatabaseDefaults)
	    { 
            if(BaseSchema == null)
                BaseSchema = DB.GetSchema("v_Orders_CashCompany");
	    ...
	    public VOrdersCashCompany(object keyID)
	    { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_Orders_CashCompany");
		    LoadByKey(keyID);
	    ...
	    public VOrdersCashCompany(string columnName, object columnValue)
        { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_Orders_CashCompany");
