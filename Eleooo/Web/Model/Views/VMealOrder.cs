...
namespace Eleooo.DAL{
    /// <summary>
    /// Strongly-typed collection for the VMealOrder class.
    /// </summary>
    [Serializable]
    public partial class VMealOrderCollection : ReadOnlyList<VMealOrder, VMealOrderCollection>
    {        
        public VMealOrderCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the v_MealOrders view.
    /// </summary>
    [Serializable]
    public partial class VMealOrder : ReadOnlyRecord<VMealOrder>, IReadOnlyRecord
    {
	    ...
	    public static TableSchema.Table Schema
        {
            get
            {
                if (BaseSchema == null)
                {
                    BaseSchema = DB.GetSchema("v_MealOrders");
                }
                return BaseSchema;
            }
        }
        ...
        public VMealOrder(bool useDatabaseDefaults)
	    { 
            if(BaseSchema == null)
                BaseSchema = DB.GetSchema("v_MealOrders");
	    ...
	    public VMealOrder(object keyID)
	    { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_MealOrders");
		    LoadByKey(keyID);
	    ...
	    public VMealOrder(string columnName, object columnValue)
        { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_MealOrders");
        ...
        public int? MansionId 
	    {
		    get
		    {
			    return GetColumnValue<int?>("MansionId");
		    }
            set 
		    {
			    SetColumnValue("MansionId", value);
            }
        }
        ...
        public decimal? ServiceSum 
	    {
		    get
		    {
			    return GetColumnValue<decimal?>("ServiceSum");
		    }
            set 
		    {
			    SetColumnValue("ServiceSum", value);
            }
        }
        ...
        public bool? IsNonOut 
	    {
		    get
		    {
			    return GetColumnValue<bool?>("IsNonOut");
		    }
            set 
		    {
			    SetColumnValue("IsNonOut", value);
            }
        }
        ...
        public int? OrderNum 
	    {
		    get
		    {
			    return GetColumnValue<int?>("OrderNum");
		    }
            set 
		    {
			    SetColumnValue("OrderNum", value);
            }
        }
        ...
        public int? OrderOper 
	    {
		    get
		    {
			    return GetColumnValue<int?>("OrderOper");
		    }
            set 
		    {
			    SetColumnValue("OrderOper", value);
            }
        }
        ...
        public int? OrderModel 
	    {
		    get
		    {
			    return GetColumnValue<int?>("OrderModel");
		    }
            set 
		    {
			    SetColumnValue("OrderModel", value);
            }
        }
        ...
        public DateTime? OrderUpdateOn 
	    {
		    get
		    {
			    return GetColumnValue<DateTime?>("OrderUpdateOn");
		    }
            set 
		    {
			    SetColumnValue("OrderUpdateOn", value);
            }
        }
        ...
        public bool? HasOutOfStock 
	    {
		    get
		    {
			    return GetColumnValue<bool?>("HasOutOfStock");
		    }
            set 
		    {
			    SetColumnValue("HasOutOfStock", value);
            }
        }
        ...
        public decimal? OrderPrePoint 
	    {
		    get
		    {
			    return GetColumnValue<decimal?>("OrderPrePoint");
		    }
            set 
		    {
			    SetColumnValue("OrderPrePoint", value);
            }
        }
        ...
        public int? MsnType 
	    {
		    get
		    {
			    return GetColumnValue<int?>("MsnType");
		    }
            set 
		    {
			    SetColumnValue("MsnType", value);
            }
        }
        ...
        public static TableSchema.TableColumn
        MansionIdColumn { get { return Schema.Columns[25]; } }
        
        public static TableSchema.TableColumn
        ServiceSumColumn { get { return Schema.Columns[26]; } }
        
        public static TableSchema.TableColumn
        IsNonOutColumn { get { return Schema.Columns[27]; } }
        
        public static TableSchema.TableColumn
        OrderNumColumn { get { return Schema.Columns[28]; } }
        
        public static TableSchema.TableColumn
        OrderOperColumn { get { return Schema.Columns[29]; } }
        
        public static TableSchema.TableColumn
        OrderModelColumn { get { return Schema.Columns[30]; } }
        
        public static TableSchema.TableColumn
        OrderUpdateOnColumn { get { return Schema.Columns[31]; } }
        
        public static TableSchema.TableColumn
        HasOutOfStockColumn { get { return Schema.Columns[32]; } }
        
        public static TableSchema.TableColumn
        OrderPrePointColumn { get { return Schema.Columns[33]; } }
        
        public static TableSchema.TableColumn
        MsnTypeColumn { get { return Schema.Columns[34]; } }
