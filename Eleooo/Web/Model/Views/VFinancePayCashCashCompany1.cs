...
namespace Eleooo.DAL{
    /// <summary>
    /// Strongly-typed collection for the VFinancePayCashCashCompany1 class.
    /// </summary>
    [Serializable]
    public partial class VFinancePayCashCashCompany1Collection : ReadOnlyList<VFinancePayCashCashCompany1, VFinancePayCashCashCompany1Collection>
    {        
        public VFinancePayCashCashCompany1Collection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the v_FinancePayCash_CashCompany1 view.
    /// </summary>
    [Serializable]
    public partial class VFinancePayCashCashCompany1 : ReadOnlyRecord<VFinancePayCashCashCompany1>, IReadOnlyRecord
    {
	    ...
	    public static TableSchema.Table Schema
        {
            get
            {
                if (BaseSchema == null)
                {
                    BaseSchema = DB.GetSchema("v_FinancePayCash_CashCompany1");
                }
                return BaseSchema;
            }
        }
	    ...
	    #region .ctors
	    public VFinancePayCashCashCompany1()
	    {
            //SetDefaults();
            //MarkNew(); 
            if(BaseSchema ==null) 
        ...
        public VFinancePayCashCashCompany1(bool useDatabaseDefaults)
	    { 
            if(BaseSchema == null)
                BaseSchema = DB.GetSchema("v_FinancePayCash_CashCompany1");
	    ...
	    public VFinancePayCashCashCompany1(object keyID)
	    { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_FinancePayCash_CashCompany1");
		    LoadByKey(keyID);
	    ...
	    public VFinancePayCashCashCompany1(string columnName, object columnValue)
        { 
            if(BaseSchema == null) 
                BaseSchema = DB.GetSchema("v_FinancePayCash_CashCompany1");
