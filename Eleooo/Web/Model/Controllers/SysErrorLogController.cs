...
{
    /// <summary>
    /// Controller class for Sys_Error_Log
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class SysErrorLogController
    {
        // Preload our schema..
        SysErrorLog thisSchemaLoad = new SysErrorLog();
        ...
        {
            return (SysErrorLog.Delete(Id) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Id)
        {
            return (SysErrorLog.Destroy(Id) == 1);
        }
