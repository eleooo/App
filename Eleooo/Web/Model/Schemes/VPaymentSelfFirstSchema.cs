...
{
	/// <summary>
	/// This is an ActiveRecord class which wraps the v_PaymentSelf_First table.
	/// </summary>
	[Serializable]
	public partial class VPaymentSelfFirstSchema : TableSchema.Table
	{
        public static TableSchema.Table Schema
        {
            get
            {
                return new VPaymentSelfFirstSchema();
            }
        }
		#region .ctors and Default Settings
		
		public VPaymentSelfFirstSchema()
            :base("v_PaymentSelf_First")
		{
		}
