...
{
	/// <summary>
	/// This is an ActiveRecord class which wraps the v_FinancePayCash_CashCompany1 table.
	/// </summary>
	[Serializable]
	public partial class VFinancePayCashCashCompany1Schema : TableSchema.Table
	{
        public static TableSchema.Table Schema
        {
            get
            {
                return new VFinancePayCashCashCompany1Schema();
            }
        }
		#region .ctors and Default Settings
		
		public VFinancePayCashCashCompany1Schema()
            :base("v_FinancePayCash_CashCompany1")
		{
		}
