<%@ Page Title="商家外卖菜单" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="SysCompanyMealMenuList.aspx.cs" Inherits="Eleooo.Web.Admin.SysCompanyMealMenuList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Admin/SysCompanyMealMenuEdit.aspx?ID={0}&IsDlg=1";
        var action_dlg_title = "编辑商家外卖菜单";
        action_dlg_height = 280;
        ...
        <tbody>
            ...
            <tr>
                <td style="line-height: 23px" width="50%">
                    ...
                    &nbsp;&nbsp; <span class="action_dlg" param="0" index="0">[新建商家外卖菜单]</span>
                </td>
            </tr>
        </tbody>
    </table>
