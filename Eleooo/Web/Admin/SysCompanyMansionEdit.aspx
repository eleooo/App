<%@ Page Title="商家外卖覆盖大厦" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="SysCompanyMansionEdit.aspx.cs" Inherits="Eleooo.Web.Admin.SysCompanyMansionEdit" %>
    ...
    <table class="tbl_body" border="0" cellspacing="1" cellpadding="5" width="99%" height="1">
        <tbody>
            ...
            <tr class="tbl_row">
                ...
                <td>
                    <input type="text" id="txtMansion" runat="server" name="txtMansion" />
                </td>
            </tr>
