<%@ Page Title="商家外卖覆盖大厦" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="SysCompanyMansionList.aspx.cs" Inherits="Eleooo.Web.Admin.SysCompanyMansionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Admin/SysCompanyMansionEdit.aspx?ID={0}&IsDlg=1";
        var action_dlg_title = "编辑商家外卖大厦";
        ...
        <tbody>
            ...
            <tr>
                <td style="line-height: 23px" width="50%">
                    ...
                    &nbsp;&nbsp; <span class="action_dlg" param="0" index="0">[新建商家外卖大厦]</span>
                </td>
            </tr>
        </tbody>
    </table>
