<%@ Page Title="好友推荐活动" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="SysRewardList.aspx.cs" Inherits="Eleooo.Web.Admin.SysRewardList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Admin/SysRewardEdit.aspx?id={0}&IsDlg=1";
        var action_dlg_title = "好友推广活动设置";
        action_dlg_height = 300;
        action_dlg_width = 600;
    </script>
