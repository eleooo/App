<%@ Page Title="佣金查询" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="FinancePayList.aspx.cs" Inherits="Eleooo.Web.Admin.FinancePayList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    ...
    <table class="tbl_body" border="0" cellspacing="1" cellpadding="5" width="100%">
        <tbody>
            <tr>
                <td class="tbl_row">
                    <span runat="server" id="lblPayRateDesc"></span>
                </td>
            </tr>
        </tbody>
    </table>
