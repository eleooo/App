<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="CompanyAdsList.aspx.cs" Inherits="Eleooo.Web.Admin.CompanyAdsList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Admin/CompanyAdsEdit.aspx?id={0}&IsDlg=1";
