<%@ Page Title="商家管理" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="CompanyList.aspx.cs" Inherits="Eleooo.Web.Admin.CompanyList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Admin/CompanyEdit.aspx?ID={0}&IsDlg=1";
        var action_dlg_title = "编辑商家";
        var action_dlg_width = 800;
        var action_dlg_height = 600;
    </script>
