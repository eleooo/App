<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcOrderMealSelectCompany.ascx.cs"
    Inherits="Eleooo.Web.Controls.UcOrderMealSelectCompany" %>
...
<ele:DataListExt ID="rpJf" runat="server" AllowPaging="false" AlternatingItemIndex="3"
    EmptyDataIsShowHeaderAndFooterTemplate="false">
    <HeaderTemplate>
        <div class="jf">
            <div class="jf-title">
                <div class="jf-new">
    ...
    <ItemTemplate>
        <li>
            <div class="jf-main-tu">
                <a href="/Member/OrderCompanyMealItem.aspx?ItemID=<%# Eval("ItemID") %>&MansionId=<%=MansionId %>"
                    target="_blank">
            ...
            <div class="jf-main-w">
                ...
                <div class="jf-mian-bq">
                    <span>
                        原价<%# Eval("ItemSum") %>元</span>
                    <p><%#Eval("ItemPoint","{0:#.##}") %>分<%# Formatter.Join("+",Formatter.ValueIf<string>(Eval("ItemNeedPay", "{0:0.##}"), "0", null),"元即享") ?? "兑换"%></p>
                </div>
                <div class="jf-main-aniu">
                    <a target="_blank" href="/Member/OrderCompanyMealItem.aspx?ItemID=<%# Eval("ItemID") %>&MansionId=<%=MansionId %>">
                        <img alt="" width="59" height="32" border="0" src="/App_Themes/ThemesV2/images/wyq.png" /></a></div>
            </div>
        </li>
    </ItemTemplate>
        ...
        <li>
            ...
            <div class="jf-main-w01">
                ...
                <div class="jf-mian-bq">
                    <span>
                        <%# Eval("ItemSum") %>元</span>
                    <p><%#Eval("ItemPoint") %>分<%# Formatter.Join("+",Formatter.ValueIf<string>(Eval("ItemNeedPay", "{0:0.##}"), "0", null),"元即享") ?? "兑换"%></p>
                </div>
                <div class="jf-main-aniu">
                    <a target="_blank" href="/Member/OrderCompanyMealItem.aspx?ItemID=<%# Eval("ItemID") %>&MansionId=<%=MansionId %>">
                        <img alt="" width="59" height="32" border="0" src="/App_Themes/ThemesV2/images/wyq.png" /></a></div>
...
<ele:DataListExt ID="rpFavCompany" runat="server" AllowPaging="false" AlternatingItemIndex="4"
    EmptyDataIsShowHeaderAndFooterTemplate="false">
    <HeaderTemplate>
        <div class="rm">
            <div class="rm-title">
    ...
    <ItemTemplate>
        <li>
            <div class="rm-main-tu">
                <%#BindCompanyInfo()%>
                <a href="/Public/OrderMealPage.aspx?CompanyId=<%#Eval("ID") %>&MansionId=<%=MansionId %>"
                    target="_blank">
                    <img border="0" src="<%#Eval("CompanyPhoto") %>" alt="" /></a></div>
            <div class="rm-main-w">
                <div class="rm-main-w-tu">
                    <a href="javascript:void(0);" title="从我的餐厅删除" onclick="__doPostBack('Delete',<%#Eval("ID") %>);">
                    </a>
                </div>
                <p>
...
<ele:DataListExt ID="rpRmCompany" runat="server" AllowPaging="false" AlternatingItemIndex="4"
    EmptyDataIsShowHeaderAndFooterTemplate="false">
    <HeaderTemplate>
        <div class="rm">
            <div class="rm-title">
