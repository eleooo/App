<%@ Page Title="查看会员点评" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="MyFacebook.aspx.cs" Inherits="Eleooo.Web.Company.MyFacebook" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/SiteAppPage/ReplyFaceBook.aspx?ID={0}&IsDlg=1";
        var action_dlg_title = "点评回复";
        var action_dlg_width = 600;
        var action_dlg_height = 330;
    </script>
</asp:Content>
        ...
        <tbody>
            ...
            <tr>
                <td style="line-height: 23px" width="50%">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                        <%=ResBLL.GetRes("searchBox_endDate","结束日期：","搜索框结束日期") %></label><input class="txtDate"
                            onclick="WdatePicker()" runat="server" id="txtDateEnd" />
                    <br />
                    <label>
