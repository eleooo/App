<%@ Page Title="广告管理-投放广告" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="CompanyAdsList.aspx.cs" Inherits="Eleooo.Web.Company.CompanyAdsList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Company/CompanyAdsEdit.aspx?id={0}&IsDlg=1";
        var action_dlg_title = "我要投放广告";
        action_dlg_height = 600;
        action_dlg_width = 700;
    </script>
