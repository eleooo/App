<%@ Page Title="储值记录" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="FinanceList.aspx.cs" EnableViewState="false" Inherits="Eleooo.Web.Company.FinanceList" %>
        ...
        <tbody>
            <tr>
                <td class="tbl_row">
                    <b>说明</b>：
                    <br />
                    <span runat="server" id="lblSaleDesc"></span>
                    <br />
