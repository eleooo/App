<%@ Page Title="提交新的问题" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="SupportEdit.aspx.cs" Inherits="Eleooo.Web.Company.SupportEdit" %>
    ...
    <script type="text/javascript" language="javascript">
        function onBtnCloseClick() {
            if (parent.dlgHandlerCallback) {
                ...
                window.location.href = "/Company/SupportList.aspx?Status=1";
            }
        }
    </script>
</asp:Content>
