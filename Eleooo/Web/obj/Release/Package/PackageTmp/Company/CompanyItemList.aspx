<%@ Page Title="优惠管理-提供优惠" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="CompanyItemList.aspx.cs" Inherits="Eleooo.Web.Company.CompanyItemList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        var action_dlg_url = "/Company/CompanyItemEdit.aspx?id={0}&IsDlg=1";
        var action_dlg_title = "我要提供优惠";
        action_dlg_height = 600;
        action_dlg_width = 550;
    </script>
        ...
        <tbody>
            ...
            <tr>
                <td style="line-height: 23px" width="50%">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <span class="action_dlg" param="0">[我要提供优惠]</span>
                </td>
            </tr>
        </tbody>
    </table>
