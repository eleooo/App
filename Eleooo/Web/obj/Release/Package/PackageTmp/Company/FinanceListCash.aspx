<%@ Page Title="储值明细" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master"
    AutoEventWireup="true" CodeBehind="FinanceListCash.aspx.cs" Inherits="Eleooo.Web.Company.FinanceListCash" %>
    ...
    <table class="tbl_body" border="0" cellspacing="1" cellpadding="5" width="100%">
        <tbody>
            <tr>
                <td class="tbl_row">
                    <b>说明</b>： 
                    <br /><span runat="server" id="lblCashDesc"></span>
                </td>
            </tr>
        </tbody>
    </table>
